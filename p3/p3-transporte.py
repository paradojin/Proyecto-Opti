...
n_max=int(input("Suma de las capacidades\nDebe ser divisible por el numero de plantas y centros de distribucion\nIngrese el valor: "))
ni=int(n_max/I)
nj=int(n_max/J)
var=int(input("Ingrese la variacion maxima de capacidad: "))
